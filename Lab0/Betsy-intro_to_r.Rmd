...
##### The number of girls baptized each year generally increased from 1629 to 1710 although there was a large dip between about 1640 and 1660.
...
##### The proportion of boys baptized is always more than 50% of the total baptisms.  
...
The Arbuthnot data covers an 82 year period of time vs. the 63 year period covered by the present data.  That's about about 30% more years of data collected in the Arbuthnot study.  I would still consider it to be on a similar time scale, but it would be better if we had the data for the years from 2003 to the present to get closer to the same number of years.  

It doesn't make sense to me to compare actual numbers of births or baptisms though since we are talking about:

- two historically different time periods (1629 - 1710 vs. 1940 - 2002), 
- two different geographical areas (London  vs. entire US), and 
- total births vs. baptisms only. 

Granted most children in that time period in London were probably baptised, but it still seems to be comparing two different data collection techiniques. So in terms of the scale of data points collected, the present US data is on a much larger scale than the Arbuthnot data with over 4 million total births at it's max vs. only a little over 16,000 total births at maximum for the Arbuthnot data. 
...
The proportion of boys to girls born in the US between 1940 and 2002 is consistently greater than 1.  There are more boys born each year in the US than girls, which is consistent with Arbuthnot's observation.  However, except for a short period of increase durging the 1960's, the proportion seems to be decreasing over time indicating that the US is getting closer to an even number of boys and girls born each year.
...
##### The greatest total number of births was in 1961.

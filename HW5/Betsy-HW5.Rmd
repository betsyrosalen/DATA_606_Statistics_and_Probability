...
If we have a 90% confidence interval then the difference of each of the bounds from the mean is equal to the margin of error and is also equal to 1.65 times the standard deviation. 
...
The margin of error is 6 and our standard deviation is approximately 3.64
